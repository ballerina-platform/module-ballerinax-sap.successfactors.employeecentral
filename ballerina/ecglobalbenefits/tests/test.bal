...
import ballerinax/sap.successfactors.ecglobalbenefits.mock as _;
...
function testBenefitEmployeeClaims() returns error? {
    json listBenefitEmployeeClaimsResult = check sfClient->listBenefitEmployeeClaims();
    test:assertTrue(listBenefitEmployeeClaimsResult !is (), "Result should not be null");
}
