...
WSO2 SAP Successfactors Ecincometaxdeclaration provides a way to interact with the SAP SuccessFactors Employee Central Income Tax Declaration APIs.
...
incometaxdlaration:Client incometaxdlarationClient = check new (
    {
      auth: {
        username,
        password
